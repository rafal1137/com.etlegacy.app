...
public final class Q3EControls {
    ...
    public static void SetupAllSize(AppCompatActivity context, float scale, boolean landscape, boolean save)
    {
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
        SharedPreferences.Editor mEdtr = preferences.edit();
    ...
    public static String[] GetDefaultLayout(AppCompatActivity context, boolean landscape)
    {
    ...
    public static String[] GetDefaultLayout(AppCompatActivity context, boolean friendly, float scale, int opacity, boolean landscape)
    {
        return Q3EButtonLayoutManager.GetDefaultLayout(context, friendly, scale, opacity, landscape);
    }

    public static int[] GetDefaultSize(AppCompatActivity context, boolean landscape)
    {
    ...
    public static Point[] GetDefaultPosition(AppCompatActivity context, boolean friendly, float scale, boolean landscape)
    {
    ...
    public static Point[] GetDefaultPosition(AppCompatActivity context, boolean friendly, boolean landscape)
    {
