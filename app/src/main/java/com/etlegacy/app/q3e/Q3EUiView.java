...
import com.etlegacy.app.q3e.onscreen.Button;
import com.etlegacy.app.q3e.onscreen.Disc;
import com.etlegacy.app.q3e.onscreen.FingerUi;
import com.etlegacy.app.q3e.onscreen.Joystick;
import com.etlegacy.app.q3e.onscreen.MenuOverlay;
import com.etlegacy.app.q3e.onscreen.Paintable;
import com.etlegacy.app.q3e.onscreen.Q3EControls;
import com.etlegacy.app.q3e.onscreen.Slider;
import com.etlegacy.app.q3e.onscreen.TouchListener;
import com.etlegacy.app.q3e.onscreen.UiElement;
import com.etlegacy.app.q3e.onscreen.UiLoader;
...
public class Q3EUiView extends GLSurfaceView/*SDLSurface*/ implements GLSurfaceView.Renderer
{
    ...
    public void UpdateOnScreenButtonsSize(float scale)
    {
        ...
        {
            Context context = getContext();
            int[] defSizes = Q3EControls.GetDefaultSize((AppCompatActivity) context, true);
    ...
    public void UpdateOnScreenButtonsPosition(boolean friendly, float scale)
    {
        ...
        {
            Context context = getContext();
            Point[] points = Q3EControls.GetDefaultPosition((AppCompatActivity) context, friendly, scale, true);
            for (int i = 0; i < paint_elements.size(); i++)
            {
                Paintable p = paint_elements.get(i);
