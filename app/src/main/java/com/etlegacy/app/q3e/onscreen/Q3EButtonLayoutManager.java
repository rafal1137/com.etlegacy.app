...
public class Q3EButtonLayoutManager {
    private final AppCompatActivity m_context;
    private float m_scale;
    private boolean m_friendly;
    private int m_opacity;
    private boolean m_landscape;

    public Q3EButtonLayoutManager(AppCompatActivity context)
    {
    ...
    public static String[] GetDefaultLayout_DIII4A(AppCompatActivity context, boolean friendly, float scale, int opacity, boolean landscape)
    {
        if (scale <= 0.0f)
            scale = 1.0f;
