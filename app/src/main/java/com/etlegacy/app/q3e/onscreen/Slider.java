        ...
        else if (act == -1)
        {
            switch (style)
            {
                case Q3EGlobals.ONSCRREN_SLIDER_STYLE_LEFT_RIGHT: {
                    ...
                    {
                        SDLActivity.onNativeKeyDown(lkey);
                        SDLActivity.onNativeKeyUp(lkey);
                    ...
                    {
                        SDLActivity.onNativeKeyDown(rkey);
                        SDLActivity.onNativeKeyUp(rkey);
                        //Q3EUtils.q3ei.callbackObj.sendKeyEvent(true, rkey, 0);
                        //Q3EUtils.q3ei.callbackObj.sendKeyEvent(false, rkey, 0);
                    }
                    else
                    {
                        SDLActivity.onNativeKeyDown(ckey);
                        SDLActivity.onNativeKeyUp(ckey);
                ...
                default: {
                    if(m_lastKey > 0)
                    {
                        SDLActivity.onNativeKeyUp(m_lastKey);
