...
public final class SupportDeveloperFunc extends GameLauncherFunc {
    ...
    private void Support_ETL() {
        AlertDialog.Builder bldr=new AlertDialog.Builder(m_gameLauncher);
        bldr.setTitle(R.string.do_you_want_to_open_dev_website);
        bldr.setPositiveButton(Q3ELang.tr(m_gameLauncher, R.string.yes) + "ET Legacy", new AlertDialog.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                ContextUtility.OpenUrlExternally(m_gameLauncher, "https://www.etlegacy.com");
                dialog.dismiss();
            }
        });
        bldr.setNegativeButton(R.string.no, new AlertDialog.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
            }
